      ...
      <div className="mt-16">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border p-6">
            ...
            <p className="mt-2 text-muted-foreground">
              You can reset your password by clicking on the "Forgot Password" link on the login page. You'll receive an
          ...
          <div className="rounded-lg border p-6">
            ...
            <p className="mt-2 text-muted-foreground">
              Yes, you can change your subscription plan at any time from your account settings. Changes will take
          ...
          <div className="rounded-lg border p-6">
            ...
            <p className="mt-2 text-muted-foreground">
              Yes, TaskMaster is available on iOS and Android. You can download the app from the App Store or Google
              Play Store.
            </p>
          </div>
          ...
          <div className="rounded-lg border p-6">
            ...
            <p className="mt-2 text-muted-foreground">
              You can cancel your subscription from your account settings. Your account will remain active until the end
