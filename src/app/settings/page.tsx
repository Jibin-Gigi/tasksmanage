      ...
      <div className="container mx-auto px-4 md:px-6 py-12 space-y-8 max-w-[1400px]">
        <div className="flex flex-col space-y-2 relative">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge variant="secondary" className="bg-violet-900/20 text-violet-200 hover:bg-violet-900/30">
              Settings
            </Badge>
          </div>
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-violet-100">Settings</h1>
          <p className="text-violet-300/80 md:text-lg">Customize your TaskQuest experience and level up your productivity.</p>
        </div>
